...
class GeminiLLMClient:
    ...
    def check_multiple_complexes_eligibility(self, complexes_list: list[dict], user_business_description: str) -> dict:
        ...
        system_inst = (
            ...
            "**[의미론적 유사도 심사 지침]**\n"
            "- 허용 유치업종명은 매우 거시적인 분류(예: '기타 기계 및 장비', '금속가공제품', '자동차')로 표현되는 경우가 많습니다.\n"
            "- 사용자의 세부 사업 내용(예: '기계 부품 가공 및 조립', '금속 정밀 가공', '볼트/너트 제조')은 해당 대분류/중분류 업종에 의미론적으로 완전히 부합하고 포함되므로, 이를 '가능' 또는 '조건부 가능'으로 판정해 주어야 합니다. 너무 협소하고 융통성 없게 불일치 처리를 하지 마십시오.\n\n"
            "**[판정 기준 규칙]**\n"
